...
urlpatterns = [
    ...
    url(r'^linguistics_Rulelist/(?P<pk>\d+)/$', views.linguistics_Rulelist, name='linguistics_Rulelist'),
    url(r'^linguistics_duplicate/(?P<pk>\d+)/$', views.linguistics_duplicate, name='linguistics_duplicate'),
