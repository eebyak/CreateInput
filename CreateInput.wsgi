...
# web application at http://eebyak.pythonanywhere.com/
...
def application(environ, start_response):
    if environ.get('PATH_INFO') == '/CreateInput':
        status = '200 OK'
...
import sys
#
## assuming your django settings file is at '/home/eebyak/mysite/mysite/settings.py'
## and your manage.py is is at '/home/eebyak/mysite/manage.py'
path = '/CreateInput'
if path not in sys.path:
    sys.path.append(path)
#
os.environ['DJANGO_SETTINGS_MODULE'] = 'CreateInput.settings'
#
## then, for django >=1.5:
...
#import sys
#
## The "/home/eebyak" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/eebyak/myproject"
#path = '/home/eebyak/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
